...
class _MobileViewState extends State<MobileView> {
  ...
  void initState() {
    ...
    _controller.cueVideoByUrl(mediaContentUrl: videoURL);
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 20),
                      const HtmlWidget('''
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/YaMSwHWv0io?si=i2OAGxLJ7J_9eFg5" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                      '''),
                      const SizedBox(height: 20),
                      ...
                      const SizedBox(height: 20),
                      const Text("이번 2024 아웃리치의 주제는 '코람데오: 하나님 앞에서'입니다."),
                      const Text(
                      ...
                      const Row(
                        children: [
                          ...
                          SelectableText("토스뱅크 100128189335 챔가대 아웃리치"),
                        ],
                      ),
                    ],
                  ),
                  ...
                  ElevatedButton.icon(
                    onPressed: () {
                      Clipboard.setData(
                          const ClipboardData(text: "토스뱅크 100128189335"));
                  ...
                  ElevatedButton.icon(
                    onPressed: () {
                      launchUrl(
                        Uri.parse("https://link.kakaopay.com/_/UcbO9wc"),
                      );
                    },
                    style: ElevatedButton.styleFrom(
